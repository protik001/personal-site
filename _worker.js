...
export default {
  async fetch(request, env) {
    ...
    if (wantsMarkdown) {
      return withSecurityHeaders(await handleMarkdownRequest(request, url, env));
    }
...
async function handleMarkdownRequest(request, url, env) {
  ...
  parts.push('- [Media](https://protik.info/media)');
  parts.push('- [Coaching](https://protik.info/coaching)');
  parts.push('- [Working With Me](https://protik.info/working-with-me)');
